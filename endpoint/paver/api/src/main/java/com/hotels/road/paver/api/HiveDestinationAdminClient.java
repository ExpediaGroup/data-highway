...
public interface HiveDestinationAdminClient {
  Optional<HiveDestination> getHiveDestination(String name) throws UnknownRoadException;

  void createHiveDestination(String name, HiveDestination hiveDestination)
