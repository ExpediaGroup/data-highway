...
public interface HiveDestinationService {
  HiveDestinationModel getHiveDestination(String name) throws UnknownRoadException, UnknownDestinationException;

  void createHiveDestination(String name, HiveDestinationModel hiveDestinationModel)
